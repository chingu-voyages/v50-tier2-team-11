...
const FetchMenuItems: React.FC = () => {
  ...
  const ActiveMenu =
    "inline-flex items-center px-4 py-3 text-white bg-[#013243] rounded-lg active w-full dark:bg-[#013243] cursor-pointer";
  const InActiveMenu =
        ...
        <div className="md:flex">
          ...
          <div className="w-full p-6 text-gray-500 rounded-lg bg-gray-50 text-medium dark:text-gray-400 dark:bg-gray-800">
            <div className="flex items-center justify-between">
              <h3 className="mb-2 text-lg font-bold text-[#B87333] dark:text-white">
